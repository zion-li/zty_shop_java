/*
 ...
 Source Schema         : db_zty

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 28/08/2021 10:59:32
*/
...
CREATE TABLE `order_info`  (
  ...
  `cash_yy` decimal(10, 2) NULL DEFAULT NULL COMMENT '营养',
  `cash_yy_assistant` int(10) NULL DEFAULT NULL,
  `cash_sx` decimal(10, 2) NULL DEFAULT NULL COMMENT '水洗',
  `cash_sx_assistant` int(10) NULL DEFAULT NULL,
  `cash_sj` decimal(10, 2) NULL DEFAULT NULL COMMENT '速焗',
  `cash_sj_assistant` int(10) NULL DEFAULT NULL,
  `cash_sp` decimal(10, 2) NULL DEFAULT NULL COMMENT '商品',
  ...
  `update_at` datetime(0) NOT NULL COMMENT '创建时间',
...
CREATE TABLE `client_info`  (
    ...
    `modile` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号',
    `rank_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户等级',
    `gender` tinyint(1) NULL DEFAULT NULL COMMENT '性别（0女、1男）',
    `birthday` date NULL DEFAULT NULL COMMENT '顾客生日',
    `account` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '总体消费',
    `last_login` datetime(0) NULL DEFAULT NULL COMMENT '最近一次到店时间',
    `service_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '服务次数',
...
CREATE TABLE `client_rank`  (
    ...
    `en_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '英文名称',
...
CREATE TABLE `staff_info`  (
  ...
  `emergency_contact_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '紧急联系人姓名',
...
CREATE TABLE `sys_user`  (
  ...
  `telephone` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '手机号',
